...
doctype_js = {
    ...
    "Job Card": ["public/js/mould_filter_applied_on_job_card.js","public/js/on_job_card_is_mold_checkbox_checked_then_mandatory_mould_field.js", "public/js/view_qc_report_button.js"],
    "Daily Production Log": ["public/js/view_qc_report_button.js"],
    ...
    "Work Order": [
        ...
        "public/js/view_qc_report_button.js"
    ],
