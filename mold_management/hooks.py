...
after_migrate = [
    ...
    #  "mold_management.patches.v0_1.add_mould_name_field_on_item.execute",
     ...
     "aims_customization.patches.v_1.add_is_mold_item_field_on_item.execute",
     "aims_customization.patches.v_1.add_is_moulding_item_checkbox_on_item.execute",
     "aims_customization.patches.v_1.add_other_than_mould_or_moulding_item.execute",
